  ...
  return ( 
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen options = { {headerShown: false}} name ="friend_req" component={FriendsRequest} />
        <Stack.Screen options = { {headerShown: false}} name ="search_friends" component={SearchFriends} />
